...
## Check is GROQ api key is provided
if api_key:
    llm=ChatGroq(api_key=api_key,model_name="openai/gpt-oss-safeguard-20b")
    ...
    if uploaded_files:
        ...
        "teh question. If you don't know the answer, say that you "
